...
/***/ "./src/content/padoZKAttestationJSSDK/index.js":
/*!*****************************************************!*\
  !*** ./src/content/padoZKAttestationJSSDK/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
window.addEventListener('message', e => {
  ...
  if (target === 'padoExtension') {
    ...
    if (name === 'removeActiveAttestation') {
      chrome.storage.local.remove(['padoZKAttestationJSSDKBeginAttest', 'padoZKAttestationJSSDKWalletAddress', 'padoZKAttestationJSSDKAttestationPresetParams', 'padoZKAttestationJSSDKXFollowerCount', 'activeRequestAttestation']);
    }
  }
});
chrome.runtime.onMessage.addListener(async (message, sender, sendResponse) => {
  ...
  if (type === 'padoZKAttestationJSSDK') {
    ...
    if (name === 'startAttestationRes') {
      console.log('padoExtension-content-sdk-receive-startAttestationRes', params);
      window.postMessage({
        target: 'padoZKAttestationJSSDK',
        origin: 'padoExtension',
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/content/padoZKAttestationJSSDK/index.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=padoZKAttestationJSSDK.bundle.js.map